...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.attendanceCreate);
        const payload = yield new attendanceService_1.default(req).create(req.body.data);
...
//# sourceMappingURL=attendanceCreate.js.map