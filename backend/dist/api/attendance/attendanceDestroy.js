...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.attendanceDestroy);
        yield new attendanceService_1.default(req).destroyAll(req.query.ids);
        const payload = true;
...
//# sourceMappingURL=attendanceDestroy.js.map