...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.attendanceImport);
        yield new attendanceService_1.default(req).import(req.body.data, req.body.importHash);
        const payload = true;
...
//# sourceMappingURL=attendanceImport.js.map