...
exports.default = (app) => {
    ...
    app.post(`/tenant/:tenantId/auth/sign-in`, signInRateLimiter, require('./authSignIn').default);
    app.post(`/tenant/:tenantId/auth/sign-up`, signUpRateLimiter, require('./authSignUp').default);
    ...
    app.get(`/auth/email-configured`, require('./authIsEmailConfigured').default);
};
