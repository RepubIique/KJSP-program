...
require('./workerRegistration').default(routes);
require('./workCode').default(routes);
require('./workDone').default(routes);
require('./attendance').default(routes);
require('./deduction').default(routes);
require('./ffb').default(routes);
require('./fFBproduction').default(routes);
require('./plantedArea').default(routes);
