...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.locationAutocomplete);
        const payload = yield new locationService_1.default(req).findAllAutocomplete(req.query.query, req.query.limit);
