...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        new permissionChecker_1.default(req).validateHas(permissions_1.default.values.locationCreate);
        const payload = yield new locationService_1.default(req).create(req.body.data);
