...
class AuditLogRepository {
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let where = {};
            let include = [];
            where = Object.assign(Object.assign({}, where), { tenantId: tenant.id });
            if (filter) {
                if (filter.timestampRange) {
                    ...
                    if (start !== undefined &&
                        start !== null &&
                        start !== '') {
                        where = Object.assign(Object.assign({}, where), { ['timestamp']: Object.assign(Object.assign({}, where.timestamp), { [Op.gte]: start }) });
                    }
                    if (end !== undefined &&
                        end !== null &&
                        end !== '') {
                        where = Object.assign(Object.assign({}, where), { ['timestamp']: Object.assign(Object.assign({}, where.timestamp), { [Op.lte]: end }) });
                    }
                }
                if (filter.action) {
                    where = Object.assign(Object.assign({}, where), { ['action']: filter.action });
                }
                if (filter.entityId) {
                    where = Object.assign(Object.assign({}, where), { ['entityId']: filter.entityId });
                }
                if (filter.createdByEmail) {
                    where = Object.assign(Object.assign({}, where), { [Op.and]: sequelizeFilterUtils_1.default.ilike('auditLog', 'createdByEmail', filter.createdByEmail) });
                }
                if (filter.entityNames && filter.entityNames.length) {
                    where = Object.assign(Object.assign({}, where), { ['entityName']: {
