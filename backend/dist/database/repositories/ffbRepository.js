...
class FfbRepository {
    ...
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.ffb.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'block',
                'budget',
                'date',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentUser = sequelizeRepository_1.default.getCurrentUser(options);
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            let record = yield options.database.ffb.findByPk(id, {
                transaction,
            });
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            if (!record ||
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.ffb.findByPk(id, {
                include,
                transaction,
            });
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.budgetRange) {
                    ...
                    if (start !== undefined && start !== null && start !== '') {
                        where = Object.assign(Object.assign({}, where), { budget: Object.assign(Object.assign({}, where.budget), { [Op.gte]: start }) });
                    }
                    if (end !== undefined && end !== null && end !== '') {
                        where = Object.assign(Object.assign({}, where), { budget: Object.assign(Object.assign({}, where.budget), { [Op.lte]: end }) });
                    }
                }
                if (filter.dateRange) {
            ...
            let { rows, count, } = yield options.database.ffb.findAndCountAll({
                where,
                include,
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.ffb.findAll({
                attributes: ['id', 'id'],
                where,
                limit: limit ? Number(limit) : undefined,
                orderBy: [['id', 'ASC']],
...
exports.default = FfbRepository;
//# sourceMappingURL=ffbRepository.js.map