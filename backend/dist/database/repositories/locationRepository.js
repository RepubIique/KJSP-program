...
class LocationRepository {
    ...
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.location.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'location',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentUser = sequelizeRepository_1.default.getCurrentUser(options);
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            let record = yield options.database.location.findByPk(id, {
                transaction,
            });
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            if (!record ||
    ...
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const include = [];
            const record = yield options.database.location.findByPk(id, {
                include,
                transaction,
            });
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.location) {
                    where = Object.assign(Object.assign({}, where), { [Op.and]: sequelizeFilterUtils_1.default.ilike('location', 'location', filter.location) });
                }
            ...
            let { rows, count, } = yield options.database.location.findAndCountAll({
                where,
                include,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                where = Object.assign(Object.assign({}, where), { [Op.or]: [
                        ...
                        {
                            [Op.and]: sequelizeFilterUtils_1.default.ilike('location', 'location', query),
                        },
                    ] });
            }
            const records = yield options.database.location.findAll({
