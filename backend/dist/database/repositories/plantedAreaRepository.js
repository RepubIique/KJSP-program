...
/**
 * Handles database operations for the PlantedArea.
 * See https://sequelize.org/v5/index.html to learn how to customize it.
 */
class PlantedAreaRepository {
    /**
     * Creates the PlantedArea.
     *
     * @param {Object} data
    ...
    static create(data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.plantedArea.create(Object.assign(Object.assign({}, lodash_1.default.pick(data, [
                'block',
                'plantedHa',
                'totalPalm',
                'importHash',
    ...
    static update(id, data, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentUser = sequelizeRepository_1.default.getCurrentUser(options);
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            let record = yield options.database.plantedArea.findByPk(id, {
                transaction,
            });
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            if (!record ||
    ...
    /**
     * Finds the PlantedArea and its relations.
     *
     * @param {string} id
     * @param {Object} [options]
     */
    static findById(id, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const record = yield options.database.plantedArea.findByPk(id, {
                include,
                transaction,
            });
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
    ...
    /**
     * Counts the number of PlantedAreas based on the filter.
     *
     * @param {Object} filter
     * @param {Object} [options]
     */
    static count(filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = sequelizeRepository_1.default.getTransaction(options);
            const tenant = sequelizeRepository_1.default.getCurrentTenant(options);
            return options.database.plantedArea.count({
    ...
    /**
     * Finds the PlantedAreas based on the query.
    ...
    static findAndCountAll({ filter, limit = 0, offset = 0, orderBy = '' }, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (filter) {
                ...
                if (filter.plantedHaRange) {
                    const [start, end] = filter.plantedHaRange;
                    if (start !== undefined && start !== null && start !== '') {
                        where = Object.assign(Object.assign({}, where), { plantedHa: Object.assign(Object.assign({}, where.plantedHa), { [Op.gte]: start }) });
                    }
                    if (end !== undefined && end !== null && end !== '') {
                        where = Object.assign(Object.assign({}, where), { plantedHa: Object.assign(Object.assign({}, where.plantedHa), { [Op.lte]: end }) });
                    }
                }
                if (filter.totalPalmRange) {
                    const [start, end] = filter.totalPalmRange;
                    if (start !== undefined && start !== null && start !== '') {
                        where = Object.assign(Object.assign({}, where), { totalPalm: Object.assign(Object.assign({}, where.totalPalm), { [Op.gte]: start }) });
                    }
                    if (end !== undefined && end !== null && end !== '') {
                        where = Object.assign(Object.assign({}, where), { totalPalm: Object.assign(Object.assign({}, where.totalPalm), { [Op.lte]: end }) });
                    }
                }
            ...
            let { rows, count, } = yield options.database.plantedArea.findAndCountAll({
                where,
                include,
    ...
    /**
     * Lists the PlantedAreas to populate the autocomplete.
     * See https://sequelize.org/v5/manual/querying.html to learn how to
     * customize the query.
     *
     * @param {Object} query
    ...
    static findAllAutocomplete(query, limit, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const records = yield options.database.plantedArea.findAll({
                attributes: ['id', 'id'],
                where,
                limit: limit ? Number(limit) : undefined,
                orderBy: [['id', 'ASC']],
    ...
    /**
     * Fills an array of PlantedArea with relations and files.
     *
     * @param {Array} rows
     * @param {Object} [options]
     */
    ...
    /**
     * Fill the PlantedArea with the relations and files.
     *
     * @param {Object} record
     * @param {Object} [options]
     */
...
exports.default = PlantedAreaRepository;
//# sourceMappingURL=plantedAreaRepository.js.map