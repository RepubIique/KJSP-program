...
class AuthService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (existingUser) {
                     ...
                     */
                    yield userRepository_1.default.updatePassword(existingUser.id, hashedPassword, Object.assign(Object.assign({}, options), { transaction, bypassPermissionValidation: true }));
    ...
    static sendEmailAddressVerificationEmail(language, email, tenantId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let link;
            try {
                const tenant = yield tenantRepository_1.default.findById(tenantId, Object.assign({}, options));
    ...
    static passwordReset(token, password, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hashedPassword = yield bcrypt_1.default.hash(password, BCRYPT_SALT_ROUNDS);
            return userRepository_1.default.updatePassword(user.id, hashedPassword, Object.assign(Object.assign({}, options), { bypassPermissionValidation: true }));
        });
    }
    static changePassword(oldPassword, newPassword, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return userRepository_1.default.updatePassword(currentUser.id, newHashedPassword, options);
        });
    }
}
