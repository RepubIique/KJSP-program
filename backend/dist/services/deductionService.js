...
const deductionRepository_1 = __importDefault(require("../database/repositories/deductionRepository"));
...
class DeductionService {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const record = yield deductionRepository_1.default.create(data, Object.assign(Object.assign({}, this.options), { transaction }));
                ...
                sequelizeRepository_1.default.handleUniqueFieldError(error, this.options.language, 'deduction');
                throw error;
            }
        });
    }
    ...
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const transaction = yield sequelizeRepository_1.default.createTransaction(this.options.database);
            try {
                const record = yield deductionRepository_1.default.update(id, data, Object.assign(Object.assign({}, this.options), { transaction }));
                yield sequelizeRepository_1.default.commitTransaction(transaction);
                return record;
            }
            catch (error) {
    ...
    destroyAll(ids) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (const id of ids) {
                    yield deductionRepository_1.default.destroy(id, Object.assign(Object.assign({}, this.options), { transaction }));
                }
                yield sequelizeRepository_1.default.commitTransaction(transaction);
            }
            catch (error) {
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return deductionRepository_1.default.findById(id, this.options);
        });
    }
    /**
    ...
    findAllAutocomplete(search, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            return deductionRepository_1.default.findAllAutocomplete(search, limit, this.options);
        });
    }
    /**
    ...
    findAndCountAll(args) {
        return __awaiter(this, void 0, void 0, function* () {
            return deductionRepository_1.default.findAndCountAll(args, this.options);
        });
    }
    /**
    ...
    _isImportHashExistent(importHash) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield deductionRepository_1.default.count({
                importHash,
            }, this.options);
            return count > 0;
        });
...
exports.default = DeductionService;
