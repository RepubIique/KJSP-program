...
class WorkCodeRepository {
  ...
  static async create(data, options) {
    ...
    const record = await options.database.workCode.create(
      {
        ...lodash.pick(data, [
          'category',
          'type',
  ...
  static async update(id, data, options) {
    ...
    let record = await options.database.workCode.findByPk(
      id,
      {
        transaction,
      },
  ...
  static async findById(id, options) {
    ...
    const record = await options.database.workCode.findByPk(
      id,
      {
        include,
        transaction,
  ...
  static async findAndCountAll(
    ...
    let {
      rows,
      count,
    } = await options.database.workCode.findAndCountAll({
      where,
      include,
  ...
  static async findAllAutocomplete(query, limit, options) {
    ...
    const records = await options.database.workCode.findAll(
      {
        attributes: ['id', 'id'],
        where,
        limit: limit ? Number(limit) : undefined,
...
export default WorkCodeRepository;
