...
class WorkDoneRepository {
  ...
  static async create(data, options) {
    ...
    const record = await options.database.workDone.create(
      {
        ...lodash.pick(data, [
          'date',
          'block',
  ...
  static async update(id, data, options) {
    ...
    let record = await options.database.workDone.findByPk(
      id,
      {
        transaction,
      },
  ...
  static async findById(id, options) {
    ...
    const record = await options.database.workDone.findByPk(
      id,
      {
        include,
        transaction,
  ...
  static async findAndCountAll(
    ...
    let {
      rows,
      count,
    } = await options.database.workDone.findAndCountAll({
      where,
      include,
  ...
  static async findAllAutocomplete(query, limit, options) {
    ...
    const records = await options.database.workDone.findAll(
      {
        attributes: ['id', 'id'],
        where,
        limit: limit ? Number(limit) : undefined,
...
export default WorkDoneRepository;
