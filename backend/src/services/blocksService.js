...
/**
 * Handles Blocks operations
 */
module.exports = class BlocksService {
  ...
  /**
   * Destroy all Blockss with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Blockss for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Blockss based on the query.
   *
   * @param {*} args
   */
