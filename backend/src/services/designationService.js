...
/**
 * Handles Designation operations
 */
module.exports = class DesignationService {
  ...
  /**
   * Destroy all Designations with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds Designations for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds Designations based on the query.
   *
   * @param {*} args
   */
  ...
  /**
   * Imports a list of Designations.
   *
   * @param {*} data
   * @param {*} importHash
   */
