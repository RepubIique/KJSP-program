...
import exporterFields from 'modules/checkroll/list/checkrollListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'CHECKROLL_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await CheckrollService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.checkroll.exporterFileName'),
