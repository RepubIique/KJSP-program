...
export default Vue.extend({
  name: 'app-deduction-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'deduction/list/hasRows',
      loading: 'deduction/list/loading',
      exportLoading: 'deduction/list/exportLoading',
      selectedRows: 'deduction/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'deduction/list/doExport',
      doRemoveAllSelected:
        'deduction/list/doRemoveAllSelected',
      doDisableAllSelected:
        'deduction/list/doDisableAllSelected',
      doEnableAllSelected:
        'deduction/list/doEnableAllSelected',
      doDestroyAll: 'deduction/destroy/doDestroyAll',
    }),
