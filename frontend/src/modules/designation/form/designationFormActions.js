...
const actions = {
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      Message.success(i18n('entities.designation.create.success'));
  ...
  doUpdate: (id, values) => async (
    ...
    try {
      ...
      await DesignationService.update(id, values);

      dispatch({
        type: actions.UPDATE_SUCCESS,
      });

      Message.success(i18n('entities.designation.update.success'));
