...
import exporterFields from 'modules/designation/list/designationListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'DESIGNATION_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      new Exporter(
        exporterFields,
        i18n('entities.designation.exporterFileName'),
