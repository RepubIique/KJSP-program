<template>
  <div style="display: flex;">
    ...
    ></el-button>
    <portal to="modal">
      <app-f-f-bproduction-form-modal
...
<script lang="ts">
import FFBproductionFormModal from '@/modules/f-f-bproduction/components/f-f-bproduction-form-modal.vue';
import { FFBproductionPermissions } from '@/modules/f-f-bproduction/f-f-bproduction-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-f-f-bproduction-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-f-f-bproduction-form-modal': FFBproductionFormModal,
  },
