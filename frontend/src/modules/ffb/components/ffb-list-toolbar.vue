...
export default Vue.extend({
  name: 'app-ffb-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'ffb/list/hasRows',
      loading: 'ffb/list/loading',
      exportLoading: 'ffb/list/exportLoading',
      selectedRows: 'ffb/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'ffb/list/doExport',
      doRemoveAllSelected:
        'ffb/list/doRemoveAllSelected',
      doDisableAllSelected:
        'ffb/list/doDisableAllSelected',
      doEnableAllSelected:
        'ffb/list/doEnableAllSelected',
      doDestroyAll: 'ffb/destroy/doDestroyAll',
    }),
