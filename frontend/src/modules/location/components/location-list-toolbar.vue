...
export default Vue.extend({
  name: 'app-location-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'location/list/hasRows',
      loading: 'location/list/loading',
      exportLoading: 'location/list/exportLoading',
      selectedRows: 'location/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'location/list/doExport',
      doRemoveAllSelected:
        'location/list/doRemoveAllSelected',
      doDisableAllSelected:
        'location/list/doDisableAllSelected',
      doEnableAllSelected:
        'location/list/doEnableAllSelected',
      doDestroyAll: 'location/destroy/doDestroyAll',
    }),
