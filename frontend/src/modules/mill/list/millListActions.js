...
import exporterFields from 'modules/mill/list/millListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'MILL_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await MillService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.mill.exporterFileName'),
