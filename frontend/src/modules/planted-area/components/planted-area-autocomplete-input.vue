...
<script lang="ts">
import PlantedAreaFormModal from '@/modules/planted-area/components/planted-area-form-modal.vue';
import { PlantedAreaPermissions } from '@/modules/planted-area/planted-area-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-planted-area-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-planted-area-form-modal': PlantedAreaFormModal,
  },
