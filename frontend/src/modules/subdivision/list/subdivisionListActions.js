...
import exporterFields from 'modules/subdivision/list/subdivisionListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'SUBDIVISION_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await SubdivisionService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.subdivision.exporterFileName'),
