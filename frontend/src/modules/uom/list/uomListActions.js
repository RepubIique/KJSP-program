...
import exporterFields from 'modules/uom/list/uomListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'UOM_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await UomService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.uom.exporterFileName'),
