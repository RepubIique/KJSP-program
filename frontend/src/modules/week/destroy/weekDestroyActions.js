...
const actions = {
  ...
  doDestroy: (id) => async (dispatch) => {
    try {
      ...
      await WeekService.destroyAll([id]);

      dispatch({
        type: actions.DESTROY_SUCCESS,
      });

      Message.success(i18n('entities.week.destroy.success'));
  ...
  doDestroyAll: (ids) => async (dispatch) => {
    try {
      ...
      await WeekService.destroyAll(ids);
      ...
      Message.success(
        i18n('entities.week.destroyAll.success'),
      );
