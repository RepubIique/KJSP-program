...
export default Vue.extend({
  name: 'app-work-done-list-toolbar',

  computed: {
    ...mapGetters({
      currentUser: 'auth/currentUser',
      currentTenant: 'auth/currentTenant',
      hasRows: 'workDone/list/hasRows',
      loading: 'workDone/list/loading',
      exportLoading: 'workDone/list/exportLoading',
      selectedRows: 'workDone/list/selectedRows',
  ...
  methods: {
    ...mapActions({
      doExport: 'workDone/list/doExport',
      doRemoveAllSelected:
        'workDone/list/doRemoveAllSelected',
      doDisableAllSelected:
        'workDone/list/doDisableAllSelected',
      doEnableAllSelected:
        'workDone/list/doEnableAllSelected',
      doDestroyAll: 'workDone/destroy/doDestroyAll',
    }),
