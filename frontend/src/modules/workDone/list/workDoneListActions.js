...
import exporterFields from 'modules/workDone/list/workDoneListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'WORKDONE_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await WorkDoneService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.workDone.exporterFileName'),
