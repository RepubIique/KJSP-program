<template>
  <div style="display: flex;">
    ...
    ></el-button>
    <portal to="modal">
      <app-worker-registration-form-modal
...
<script lang="ts">
import WorkerRegistrationFormModal from '@/modules/worker-registration/components/worker-registration-form-modal.vue';
import { WorkerRegistrationPermissions } from '@/modules/worker-registration/worker-registration-permissions';
import { mapGetters } from 'vuex';

import Vue from 'vue';
export default Vue.extend({
  name: 'app-worker-registration-autocomplete-input',
  props: [
    'value',
    'mode',
    'fetchFn',
  ...
  components: {
    'app-worker-registration-form-modal': WorkerRegistrationFormModal,
  },
