...
import exporterFields from 'modules/workerRegistration/list/workerRegistrationListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'WORKERREGISTRATION_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      new Exporter(
        exporterFields,
        i18n('entities.workerRegistration.exporterFileName'),
