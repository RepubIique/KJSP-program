...
import AttendanceFormModal from 'view/attendance/form/AttendanceFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/attendance/attendanceSelectors';

class AttendanceAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
...
export default connect(select)(
  AttendanceAutocompleteFormItem,
);
