...
import actions from 'modules/attendance/importer/attendanceImporterActions';
import fields from 'modules/attendance/importer/attendanceImporterFields';

class AttendanceImportPage extends Component {
  render() {
      ...
      <React.Fragment>
        <Breadcrumb
          items={[
            ...
            [
              i18n(
                'entities.attendance.importer.title',
              ),
            ],
          ]}
        />
