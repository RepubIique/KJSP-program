...
import BlocksFormModal from 'view/blocks/form/BlocksFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/blocks/blocksSelectors';

class BlocksAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return BlocksService.listAutocomplete(value, limit);
  };
  ...
  mapper = {
    toAutocomplete(originalValue) {
      ...
      if (originalValue['blocks']) {
        label = originalValue['blocks'];
      }
