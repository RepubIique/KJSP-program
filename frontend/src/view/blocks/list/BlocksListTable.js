...
class BlocksListTable extends Component {
  state = {
              ...
              {!loading &&
                rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      {fields.blocks.forView(
                        row[fields.blocks.name],
                      )}
                    </TableCell>
                    <TableCell>
                      <Box display="flex">
...
export default connect(select)(BlocksListTable);
