...
import CheckrollFormModal from 'view/checkroll/form/CheckrollFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/checkroll/checkrollSelectors';

class CheckrollAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return CheckrollService.listAutocomplete(value, limit);
  };
