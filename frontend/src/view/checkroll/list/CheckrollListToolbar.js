...
import checkrollSelectors from 'modules/checkroll/checkrollSelectors';
import destroyActions from 'modules/checkroll/destroy/checkrollDestroyActions';
import destroySelectors from 'modules/checkroll/destroy/checkrollDestroySelectors';
...
class CheckrollToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=checkroll"
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: checkrollSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: checkrollSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: checkrollSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: checkrollSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(CheckrollToolbar);
