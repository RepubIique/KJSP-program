...
import DeductionFormModal from 'view/deduction/form/DeductionFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/deduction/deductionSelectors';

class DeductionAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return DeductionService.listAutocomplete(value, limit);
  };
  ...
  mapper = {
    toAutocomplete(originalValue) {
      ...
      if (originalValue['deductfor']) {
        label = originalValue['deductfor'];
      }
