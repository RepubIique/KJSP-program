...
class DesignationToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=designation"
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: designationSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: designationSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(DesignationToolbar);
