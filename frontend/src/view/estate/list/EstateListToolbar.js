...
import estateSelectors from 'modules/estate/estateSelectors';
import destroyActions from 'modules/estate/destroy/estateDestroyActions';
import destroySelectors from 'modules/estate/destroy/estateDestroySelectors';
...
class EstateToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=estate"
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: estateSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: estateSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: estateSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: estateSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(EstateToolbar);
