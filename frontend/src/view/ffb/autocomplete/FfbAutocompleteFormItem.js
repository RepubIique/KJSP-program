...
import FfbFormModal from 'view/ffb/form/FfbFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/ffb/ffbSelectors';

class FfbAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return FfbService.listAutocomplete(value, limit);
  };
