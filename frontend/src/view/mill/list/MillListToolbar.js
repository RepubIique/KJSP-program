...
import millSelectors from 'modules/mill/millSelectors';
import destroyActions from 'modules/mill/destroy/millDestroyActions';
import destroySelectors from 'modules/mill/destroy/millDestroySelectors';
import actions from 'modules/mill/list/millListActions';
import selectors from 'modules/mill/list/millListSelectors';
...
class MillToolbar extends Component {
  state = {
    ...
    return (
      <ToolbarWrapper>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Button
            component={Link}
            to="/audit-logs?entityNames=mill"
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: millSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: millSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: millSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: millSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(MillToolbar);
