...
class SubdivisionListTable extends Component {
  state = {
              ...
              {!loading &&
                rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      {fields.subdivision.forView(
                        row[fields.subdivision.name],
                      )}
                    </TableCell>
                    <TableCell>
                      <Box display="flex">
...
export default connect(select)(SubdivisionListTable);
