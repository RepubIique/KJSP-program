...
class SubdivisionViewItem extends Component {
  valueAsArray = () => {
  ...
  displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record['subdivision']}</div>;
  };
...
export default connect(select)(SubdivisionViewItem);
