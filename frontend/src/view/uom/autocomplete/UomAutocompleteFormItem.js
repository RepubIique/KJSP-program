...
import UomFormModal from 'view/uom/form/UomFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/uom/uomSelectors';

class UomAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return UomService.listAutocomplete(value, limit);
  };
  ...
  mapper = {
    toAutocomplete(originalValue) {
      ...
      if (originalValue['uom']) {
        label = originalValue['uom'];
      }
