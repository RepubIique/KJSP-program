...
import uomSelectors from 'modules/uom/uomSelectors';
import destroyActions from 'modules/uom/destroy/uomDestroyActions';
import destroySelectors from 'modules/uom/destroy/uomDestroySelectors';
import actions from 'modules/uom/list/uomListActions';
import selectors from 'modules/uom/list/uomListSelectors';
...
class UomToolbar extends Component {
  state = {
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: uomSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: uomSelectors.selectPermissionToDestroy(
      state,
    ),
    hasPermissionToCreate: uomSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: uomSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(UomToolbar);
