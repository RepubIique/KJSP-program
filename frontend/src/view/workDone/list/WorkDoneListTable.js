...
import actions from 'modules/workDone/list/workDoneListActions';
import destroyActions from 'modules/workDone/destroy/workDoneDestroyActions';
import selectors from 'modules/workDone/list/workDoneListSelectors';
import destroySelectors from 'modules/workDone/destroy/workDoneDestroySelectors';
import model from 'modules/workDone/workDoneModel';
import workDoneSelectors from 'modules/workDone/workDoneSelectors';
...
class WorkDoneListTable extends Component {
  state = {
              ...
              {!loading &&
                rows.map((row) => (
                  <TableRow key={row.id}>
                    ...
                    <TableCell>
                      {fields.block.forView(
                        row[fields.block.name],
                      )}
                    </TableCell>
                    <TableCell>
...
function select(state) {
  return {
    ...
    hasPermissionToEdit: workDoneSelectors.selectPermissionToEdit(
      state,
    ),
    hasPermissionToDestroy: workDoneSelectors.selectPermissionToDestroy(
      state,
    ),
  };
}

export default connect(select)(WorkDoneListTable);
