...
class WorkcodeListItem extends Component {
  valueAsArray = () => {
  ...
  displayableRecord = (record) => {
    ...
    return <div key={record.id}>{record['accCode']}</div>;
  };
...
export default connect(select)(WorkcodeListItem);
